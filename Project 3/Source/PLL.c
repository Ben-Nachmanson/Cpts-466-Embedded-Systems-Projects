// bus frequency is 400MHz/(SYSDIV2+1), for instance, if SYSDIV2=7 then Clock = 400MHz/(7+1) = 50 MHz
...
#define SYSDIV2 4 // This is where we can set the desired clock frequency
